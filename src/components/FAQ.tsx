...
const faqs = [
  ...
  },
  {
    ...
    answer: 'След като закупите билет ще получите детайли по имейл - линкът за срещите ще бъде изпратен на 9 май, 5 дни преди първата сесия. Допълнително ще бъде споделен и във Viber групата 1 час преди началото на всяка сесия.'
  },
  {
