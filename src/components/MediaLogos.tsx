      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-0">
          ...
          <div className="flex items-center gap-2 sm:pr-8 sm:border-r flex-shrink-0" style={{ borderColor: 'rgba(14,45,87,0.80)' }}>
            <span className="text-xs font-bold tracking-[0.20em] uppercase whitespace-nowrap" style={{ color: 'rgba(148,163,184,0.55)' }}>
              Споменат в
            </span>
          </div>

          {/* Logos */}
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-8 sm:gap-10 lg:gap-12 sm:pl-8 w-full">
            {logos.map((logo) => (
